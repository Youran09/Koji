  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-koji-cream via-koji-cream to-koji-cream-dark relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-br from-koji-green/10 to-koji-teal/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-br from-koji-teal/8 to-koji-green/8 rounded-full blur-3xl"></div>
